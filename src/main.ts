...
let hello3 = (name: string) => console.log("hello " + name + " 2")
hello3(jean.name)
...
function hello4(named: Named) {
    console.log("hello " + named.name + " 3")
}
...
const str = "name"
let jean4: ICharacter = { name : "Jean SUUUUUUU", age: 24}		// syntaxe nom
